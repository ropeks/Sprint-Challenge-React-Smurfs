...
A: Server side routing reloads the whole page after server sends some information and client side routing doesn't trigger page to refresh and only the component whose state/props was changed rerenders.
